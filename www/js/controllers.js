angular.module('starter.controllers', [])
    ...
    $scope.doLogin = function() {
      ...
      if(security.email($scope.login.email) && security.password($scope.login.password)) {
        ...
        $http({
              ...
              url: 'http://zenitth.com/account/logins',
  ...
  .controller('RegisterCtrl', function($scope, $stateParams, $http, $state, security, serialize) {
    ...
    $http({
        method: 'GET',
        url: 'http://zenitth.com/account/brands'
      })
      .success( function (data, status, headers, config) {
        $scope.brands = data;
      })
    ...
    $scope.doRegister = function() {
      ...
      if (
            ...
            $http({
              method: 'POST',
              headers: {'Content-Type': 'application/x-www-form-urlencoded'},
              url: 'http://zenitth.com/account/registers',
  ...
  .controller('QueryCtrl', function($scope, $stateParams, $timeout, $state, $http, $ionicPopup, $ionicHistory, serialize) {
    ...
    $http({
      method: 'GET',
      url: 'http://zenitth.com/api/quizz?access_token=' + access_token,
    })
    .success( function (data, status, headers, config) {
    ...
    $scope.finish = function() {
      ...
      $http({
        method: 'POST',
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
        url: 'http://zenitth.com/api/scores?access_token=' + access_token,
  ...
  .controller('DashboardCtrl', function($scope, $stateParams, $state, $http) {
    ...
    $http({
      method: 'GET',
      url: 'http://zenitth.com/api/dashboard?access_token=' + access_token,
    })
    .success( function (data, status, headers, config) {
  ...
  .controller('DefiCtrl', function($scope, $stateParams, $state, $http, serialize) {
    ...
    $http({
      method: 'GET',
      url: 'http://zenitth.com/api/defi/question?access_token=' + access_token,
    })
    .success( function (data, status, headers, config) {
     $scope.defi = data;
    ...
    $scope.end = function() {
      $http({
        method: 'POST',
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
        url: 'http://zenitth.com/api/defis/validates?access_token=' + access_token,
  ...
  .controller('NotificationsCtrl', function($scope, $http, $state, security, serialize) {
    ...
    $http({
      method: 'GET',
      url: 'http://zenitth.com/api/notifications?access_token=' + access_token,
    })
    .success( function (data, status, headers, config) {
  ...
  .controller('DefirequestCtrl', function($scope, $stateParams, $http, $state, security, serialize, shareDataService) {
    ...
    $http({
      method: 'GET',
      url: 'http://zenitth.com/api/defis/' + id + '?access_token=' + access_token,
    })
    .success( function (data, status, headers, config) {
     $scope.defi = data;
  ...
  .controller('DefiquestionCtrl', function($scope, $stateParams, $http, $state, $timeout, $interval, security, serialize, shareDataService) {
    ...
    $scope.response = function() {
      ...
      $http({
        method: 'POST',
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
        url: 'http://zenitth.com/api/responses/defis?access_token=' + access_token,
